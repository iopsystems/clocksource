...
/// An atomic precise measurement of a monotonically nondecreasing clock.
///
/// It is opaque and useful only with the duration types.
///
/// Internally, it represents the instant as a whole number of nanoseconds from
...
impl AtomicInstant {
    ...
    /// description of the memory orderings.
    ///
    /// Unlike `AtomicInstant::compare_exchange`, this function is allowed to
    ...
    /// Adds a duration to the current instant, returning the previous instant.
    ///
    /// This operation wraps around on overflow.
    ///
    /// See: [`core::sync::atomic::AtomicU64::fetch_add`] for details on the
    /// ordering semantics.
    ///
    /// *Note*: This method is only available on platforms that support atomic
    /// operations on `u64`.
